function [x_bar_min,x_bar_max] = Split_Longest_Edge(W,b,xmin,xmax,k)
...
while(i<k)
    ...
    X1 = Generate_Inputs(x_1_bar_min, x_1_bar_max, 1);
    X2 = Generate_Inputs(x_2_bar_min, x_2_bar_max, 1);
